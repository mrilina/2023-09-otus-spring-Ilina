...
class BookControllerTest {
    ...
    void shouldCreateNewBook() throws Exception {
        ...
        bookDto.setTitle("firstBook");
        bookDto.setAuthorId(1L);
        bookDto.setGenreId(1L);

        var expectedBookDto = BookMapper.mapBookToDto(expectedBook);

        given(bookService.create(any(BookUpdateDto.class))).willReturn(expectedBookDto);
        ...
        verify(bookService, times(1)).create(any(BookUpdateDto.class));
    }
